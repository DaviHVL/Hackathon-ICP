          ...
          <nav class="bg-white border-gray-200 py-2.5 dark:bg-gray-900">
            <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
              ...
              <div class="flex items-center lg:order-2 space-x-4">
                <a
                  onClick={login}
                  class="text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 dark:bg-purple-600 dark:hover:bg-purple-700 focus:outline-none dark:focus:ring-purple-800 cursor-pointer "
                >
                  Login
                </a>
                <button
          ...
          <div class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
            <div class="mr-auto place-self-center lg:col-span-7">
              ...
              <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
                Crie landing pages incríveis em poucos cliques com nosso gerador
                intuitivo! Escolha entre templates pré-definidos, personalize
                conforme sua necessidade e publique em segundos. Tudo isso na
                Blockchain da ICP!
              </p>
          ...
          <div class="max-w-screen-xl px-4 pb-8 mx-auto lg:pb-16">
            <div class="grid grid-cols-2 gap-8 text-gray-500 sm:gap-12 sm:grid-cols-3 lg:grid-cols-6 dark:text-gray-400">
              <a href="#" class="flex items-center lg:justify-center">
                <img
                  src="./images/img2.jpg"
                  class="h-[70px] hover:text-gray-900 dark:hover:text-white"
                />
              </a>
              <a href="#" class="flex items-center lg:justify-center">
                <img
          ...
          <div class="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
            <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
              <div class="text-gray-500 sm:text-lg dark:text-gray-400">
                <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">
                  Crie Landing Page de forma intuitiva
                </h2>
                <p class="mb-8 font-light lg:text-xl">
                  Crie landing pages de forma simples e intuitiva, sem precisar
                  de conhecimentos técnicos, em apenas 3 passos!
                </p>
                ...
                <p class="mb-8 font-light lg:text-xl">
                  Simples assim, depois disso basta publicar!
                </p>
              </div>
              <img
                class="hidden w-[80%] mb-4 rounded-lg lg:mb-0 lg:flex"
            ...
            <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
              ...
              <div class="text-gray-500 sm:text-lg dark:text-gray-400">
                ...
                <p class="mb-8 font-light lg:text-xl">
                  Landing pages são páginas web criadas com um objetivo
                  específico, geralmente relacionado a marketing. Elas pode ser
                ...
                <p class="font-light lg:text-xl">
                  Elas podem ser utilizadas também para várias outras
                  finalidades.
                </p>
              </div>
            </div>
          ...
          <div class="items-center max-w-screen-xl px-4 py-8 mx-auto lg:grid lg:grid-cols-4 lg:gap-16 xl:gap-24 lg:py-24 lg:px-6">
            <div class="col-span-2 mb-8">
              ...
              <h2 class="mt-3 mb-4 text-3xl font-extrabold tracking-tight text-gray-900 md:text-3xl dark:text-white">
                Mais de 3000 landing pages geradas ao redor do mundo!
              </h2>
              <p class="font-light text-gray-500 sm:text-xl dark:text-gray-400">
                A facilidade de criar landing pages transformou este projeto em
                um sucesso no mundo inteiro!
              </p>
            ...
            <div class="col-span-2 space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0">
              ...
              <div>
                ...
                <p class="font-light text-gray-500 dark:text-gray-400">
                  Mais de 600 usuários ao redor do mundo
                </p>
              </div>
              <div>
                <svg
                ...
                <p class="font-light text-gray-500 dark:text-gray-400">
                  Utilizado em mais de 10 paises
                </p>
              </div>
              <div>
                <svg
            ...
            <figure class="max-w-screen-md mx-auto">
              ...
              <blockquote>
                <p class="text-xl font-medium text-gray-900 md:text-2xl dark:text-white">
                  "Antes de usar o gerador de landing pages, eu dependia de
                  outras pessoas para divulgar meus eventos, o que era caro e
                  demorado. Agora, consigo criar uma página profissional em
                  apenas 5 minutos! Isso mudou completamente a forma como
                  trabalho e trouxe mais agilidade para o meu dia a dia."
                </p>
              </blockquote>
          ...
          <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-24 lg:px-6">
            <div class="max-w-screen-md mx-auto mb-8 text-center lg:mb-12">
              ...
              <p class="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">
                Temos planos que se adaptam às suas necessidades e ao seu
                orçamento, para todos os perfils de usuários. Explore nossas
                opções e escolha o plano ideal para começar a criar landing
                pages personalizadas, seguras e totalmente on-chain. Sem taxas
                ocultas!
              </p>
            </div>
            <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
              <div class="flex flex-col max-w-lg p-6 mx-auto text-center text-gray-900 bg-white border border-gray-100 rounded-lg shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                ...
                <p class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                  Melhor opção para quem está iniciando no mundo de landing
                  page.
                </p>
                ...
                <ul role="list" class="mb-8 space-y-4 text-left">
                  ...
                  <li class="flex items-center space-x-3">
                    ...
                    <span>
                      No máximo:{" "}
                      <span class="font-semibold">100 mb de armazenamento</span>
                    </span>
                  </li>
                  <li class="flex items-center space-x-3">
                    <svg
                    ...
                    <span>
                      Disponível:{" "}
                      <span class="font-semibold">24 horas por dia</span> e{" "}
                      <span class="font-semibold">7 dias por semana</span>
                    </span>
                  </li>
                </ul>
                <a
              ...
              <div class="flex flex-col max-w-lg p-6 mx-auto text-center text-gray-900 bg-white border border-gray-100 rounded-lg shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                ...
                <p class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                  Melhor opção para quem cria landing page recorrentemente.
                </p>
                <div class="flex items-baseline justify-center my-8">
              ...
              <div class="flex flex-col max-w-lg p-6 mx-auto text-center text-gray-900 bg-white border border-gray-100 rounded-lg shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                ...
                <p class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                  Melhor opção para quem cria landing page em larga escala.
                </p>
                <div class="flex items-baseline justify-center my-8">
                ...
                <ul role="list" class="mb-8 space-y-4 text-left">
                  ...
                  <li class="flex items-center space-x-3">
                    ...
                    <span>
                      Armazenamento ilimitado (não possui limite máximo)
                    </span>
                  </li>
                  <li class="flex items-center space-x-3">
                    <svg
            ...
            <div class="max-w-screen-md mx-auto">
              ...
              >
                <h3 id="accordion-flush-heading-1">
                  ...
                  >
                    <span>
                      Eu preciso ser um Web Design para criar as Landing Pages?
                    </span>
                    <svg
                      data-accordion-icon=""
                ...
                >
                  <div class="py-5 border-b border-gray-200 dark:border-gray-700">
                    <p class="mb-2 text-gray-500 dark:text-gray-400">
                      Você não precisa de conhecimentos técnicos para criar suas
                      páginas web. Basta selecionar o template de sua
                      preferência, adicionar seus textos e imagens, e pronto!
                ...
                <h3 id="accordion-flush-heading-3">
                  ...
                  >
                    <span>
                      O governo poderá tirar minha landing page do ar?
                    </span>
                    <svg
                      data-accordion-icon=""
                      class="w-6 h-6 shrink-0"
          ...
          <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-16 lg:px-6">
            <div class="max-w-screen-sm mx-auto text-center">
              ...
              <p class="mb-6 font-light text-gray-500 dark:text-gray-400 md:text-lg">
                Crie a sua primeira landing page sem custos.
              </p>
              <a
                href="#"
