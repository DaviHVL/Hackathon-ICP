...
const canisterId =
  ...
  /(.*?)(?:\.raw)?\.icp0.io/.exec(window.location.host)?.[1] ??
...
function t2pageconfig() {
  ...
  function defineValoresIniciais() {
    setLoading(true);
    pagesProps.set("secao1_prop1", "Imagem do Site");
    pagesProps.set("secao1_prop2", "Nome do Site");
    pagesProps.set("secao1_prop3", "Botão 1");
    pagesProps.set("secao1_prop4", "Botão 2");
    ...
    pagesProps.set("secao2_prop3", "Imagem");

    pagesProps.set("secao3_prop7", "Imagem 1");
    pagesProps.set("secao3_prop8", "Imagem 2");
    pagesProps.set("secao3_prop9", "Imagem 3");
    pagesProps.set("secao3_prop10", "Imagem 4");
    pagesProps.set("secao3_prop11", "Imagem 5");
    pagesProps.set("secao3_prop12", "Imagem 6");
    ...
    pagesProps.set(
      "secao5_prop4",
      "Texto de Link. Recomendado no máximo 1 linha."
    );
    pagesProps.set(
      "secao5_prop5",
      "Texto de Link. Recomendado no máximo 1 linha."
    ...
    pagesProps.set(
      "secao7_prop1",
      "TITULO DA TABELA. Recomendado no máximo 1 linha."
    );
    ...
    pagesProps.set(
      "secao8_prop3",
      "Resposta 1. Recomendado no máximo 4 linha."
    );
    ...
    pagesProps.set("secao10_prop1", "TITULO. Recomendado no máximo 1 linha.");
    pagesProps.set(
      "secao10_prop2",
  ...
  async function salvarPage() {
    ...
    try {
      ...
      pagesSections.forEach((value, key) => {
        const section = { nomePage: nome, identificador: key, exibir: value };
      ...
      <body>
        ...
        <div class="flex items-start mb-6">
          <div class="flex items-center h-5 ml-[20px]">
            <input
              checked={Boolean(pagesSections.get("secao1"))}
              onChange={() =>
                alterarPageSection(
                  "secao1",
                  !Boolean(pagesSections.get("secao1"))
                )
              }
              id="remember"
              type="checkbox"
          ...
          <header className="bg-white dark:bg-gray-900">
            <div className="max-w-screen-xl mx-auto px-4 py-6 flex items-center justify-between pr-10">
              <div className="flex items-center space-x-4">
                  ...
                  <div className="w-[30px] h-[33px]">
                    ...
                    >
                      <div className="flex flex-col items-center justify-center pt-1 pb-1">
                        ...
                        <p className="mb-1 text-[8px] text-gray-500 dark:text-gray-400">
                      ...
                      <input
                        ...
                        type="file"
                        className="hidden"
                        onChange={(e) => selectImg(e, "secao1_prop1")}
                      />
                    </label>
                  </div>
                )}
                ...
                <button
                  type="button"
                  onClick={() => exibirModalCustomizacao("secao1_prop2")}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
              ...
              <input
                ...
                className="flex-1 mx-6 px-10 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
              />

              <div className="flex space-x-4 pl-10">
                <a className="text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-purple-600 dark:hover:bg-purple-700 focus:outline-none dark:focus:ring-purple-800">
                  {pagesProps.get("secao1_prop3") || ""}
                </a>
                <button
                  type="button"
                  onClick={() => exibirModalCustomizacao("secao1_prop3")}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                ...
                <button
                  type="button"
                  onClick={() => exibirModalCustomizacao("secao1_prop4")}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
        ...
        <div class="flex items-start mb-6">
          <div class="flex items-center h-5 ml-[20px]">
            <input
              checked={Boolean(pagesSections.get("secao2"))}
              onChange={() =>
                alterarPageSection(
                  "secao2",
                  !Boolean(pagesSections.get("secao2"))
                )
              }
              id="remember"
              type="checkbox"
            ...
            <div class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
              <div class="mr-auto place-self-center lg:col-span-7">
                ...
                <button
                  type="button"
                  onClick={() => {
                    exibirModalCustomizacao("secao2_prop1");
                  }}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
                  ...
                  <button
                    type="button"
                    onClick={() => {
                      exibirModalCustomizacao("secao2_prop2");
                    }}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
              ...
              {(!pagesImg.has("secao2_prop3") ||
                pagesImg.get("secao2_prop3")?.url === "" ||
                pagesImg.get("secao2_prop3")?.url === null) && (
                <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                  <label
                    for="dropzone-file1"
                    class=" flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600"
                  >
                ...
                pagesImg.get("secao2_prop3")?.url != null && (
                  <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                    <figure class="max-w-lg">
                      <img
                        src={pagesImg.get("secao2_prop3")?.url}
                        loading={"lazy"}
        ...
        <div class="flex items-start mb-6">
          <div class="flex items-center h-5 ml-[20px]">
            <input
              checked={Boolean(pagesSections.get("secao3"))}
              onChange={() =>
                alterarPageSection(
                  "secao3",
                  !Boolean(pagesSections.get("secao3"))
                )
              }
              id="remember"
              type="checkbox"
              ...
              <div className="grid grid-cols-2 gap-8 text-gray-500 sm:gap-12 sm:grid-cols-3 lg:grid-cols-6 dark:text-gray-400">
                ...
                <div className="flex flex-col items-center">
                  <a className="flex items-center justify-center">
                    {(!pagesImg.has("secao3_prop1") ||
                      pagesImg.get("secao3_prop1")?.url === "" ||
                      pagesImg.get("secao3_prop1")?.url === null) && (
                      <div className="w-full h-[80px] flex items-center justify-center border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500">
                        <label
                        ...
                        >
                          <div className="flex flex-col items-center justify-center pt-1 pb-1">
                            <svg
                              className="w-[30px] h-[30px] mb-1 text-gray-500 dark:text-gray-400"
                              aria-hidden="true"
                              xmlns="http://www.w3.org/2000/svg"
                              fill="none"
                              viewBox="0 0 20 16"
                          ...
                          <input
                            ...
                            type="file"
                            className="hidden"
                            onChange={(e) => selectImg(e, "secao3_prop1")}
                          />
                        </label>
                      </div>
                    )}
                  ...
                  <span className="text-xl font-semibold whitespace-nowrap dark:text-white">
                    {pagesProps.get("secao3_prop7")}
                  </span>
                  <button
                    type="button"
                    onClick={() => exibirModalCustomizacao("secao3_prop7")}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                ...
                <div className="flex flex-col items-center">
                      ...
                      <div className="w-full h-[80px] flex items-center justify-center border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500">
                        ...
                        >
                          ...
                          <input
                            ...
                            type="file"
                            className="hidden"
                            onChange={(e) => selectImg(e, "secao3_prop2")}
                          />
                        </label>
                      </div>
                    )}
                  ...
                  <span className="text-xl font-semibold whitespace-nowrap dark:text-white">
                    {pagesProps.get("secao3_prop8")}
                  </span>
                  <button
                    type="button"
                    onClick={() => exibirModalCustomizacao("secao3_prop8")}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                ...
                <div className="flex flex-col items-center">
                      ...
                      <div className="w-full h-[80px] flex items-center justify-center border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500">
                        ...
                        >
                          ...
                          <input
                            ...
                            type="file"
                            className="hidden"
                            onChange={(e) => selectImg(e, "secao3_prop3")}
                          />
                        </label>
                      </div>
                    )}
                  ...
                  <span className="text-xl font-semibold whitespace-nowrap dark:text-white">
                    {pagesProps.get("secao3_prop9")}
                  </span>
                  <button
                    type="button"
                    onClick={() => exibirModalCustomizacao("secao3_prop9")}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                ...
                <div className="flex flex-col items-center">
                      ...
                      <div className="w-full h-[80px] flex items-center justify-center border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500">
                        ...
                        >
                          ...
                          <input
                            ...
                            type="file"
                            className="hidden"
                            onChange={(e) => selectImg(e, "secao3_prop4")}
                          />
                        </label>
                      </div>
                    )}
                  ...
                  <span className="text-xl font-semibold whitespace-nowrap dark:text-white">
                    {pagesProps.get("secao3_prop10")}
                  </span>
                  <button
                    type="button"
                    onClick={() => exibirModalCustomizacao("secao3_prop10")}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                ...
                <div className="flex flex-col items-center">
                      ...
                      <div className="w-full h-[80px] flex items-center justify-center border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500">
                        ...
                        >
                          ...
                          <input
                            ...
                            type="file"
                            className="hidden"
                            onChange={(e) => selectImg(e, "secao3_prop5")}
                          />
                        </label>
                      </div>
                    )}
                  ...
                  <span className="text-xl font-semibold whitespace-nowrap dark:text-white">
                    {pagesProps.get("secao3_prop11")}
                  </span>
                  <button
                    type="button"
                    onClick={() => exibirModalCustomizacao("secao3_prop11")}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                ...
                <div className="flex flex-col items-center">
                      ...
                      <div className="w-full h-[80px] flex items-center justify-center border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500">
                        ...
                        >
                          ...
                          <input
                            ...
                            type="file"
                            className="hidden"
                            onChange={(e) => selectImg(e, "secao3_prop6")}
                          />
                        </label>
                      </div>
                    )}
                  ...
                  <span className="text-xl font-semibold whitespace-nowrap dark:text-white">
                    {pagesProps.get("secao3_prop12")}
                  </span>
                  <button
                    type="button"
                    onClick={() => exibirModalCustomizacao("secao3_prop12")}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
        ...
        <div class="flex items-start mb-6">
          <div class="flex items-center h-5 ml-[20px]">
            <input
              checked={Boolean(pagesSections.get("secao4"))}
              onChange={() =>
                alterarPageSection(
                  "secao4",
                  !Boolean(pagesSections.get("secao4"))
                )
              }
              id="remember"
              type="checkbox"
              ...
              <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                <div class="text-gray-500 sm:text-lg dark:text-gray-400">
                  ...
                  <button
                    type="button"
                    onClick={() => {
                      exibirModalCustomizacao("secao4_prop1");
                    }}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <p class="mb-8 font-light lg:text-xl">
                    ...
                    <button
                      type="button"
                      onClick={() => {
                        exibirModalCustomizacao("secao4_prop2");
                      }}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  >
                    <li class="flex space-x-3">
                      ...
                      <button
                        type="button"
                        onClick={() => {
                          exibirModalCustomizacao("secao4_prop3");
                        }}
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                    ...
                    <li class="flex space-x-3">
                      ...
                      <button
                        type="button"
                        onClick={() => {
                          exibirModalCustomizacao("secao4_prop4");
                        }}
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                    ...
                    <li class="flex space-x-3">
                      ...
                      <button
                        type="button"
                        onClick={() => {
                          exibirModalCustomizacao("secao4_prop5");
                        }}
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                  ...
                  <p class="mb-8 font-light lg:text-xl">
                    ...
                    <button
                      type="button"
                      onClick={() => {
                        exibirModalCustomizacao("secao4_prop6");
                      }}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="flex items-start mb-6">
          <div class="flex items-center h-5 ml-[20px]">
            <input
              checked={Boolean(pagesSections.get("secao5"))}
              onChange={() =>
                alterarPageSection(
                  "secao5",
                  !Boolean(pagesSections.get("secao5"))
                )
              }
              id="remember"
              type="checkbox"
        ...
        <div class="flex items-start mb-6">
          <div class="flex items-center h-5 ml-[20px]">
            <input
              checked={Boolean(pagesSections.get("secao6"))}
              onChange={() =>
                alterarPageSection(
                  "secao6",
                  !Boolean(pagesSections.get("secao6"))
                )
              }
              id="remember"
              type="checkbox"
        ...
        <div class="flex items-start mb-6">
          <div class="flex items-center h-5 ml-[20px]">
            <input
              checked={Boolean(pagesSections.get("secao7"))}
              onChange={() =>
                alterarPageSection(
                  "secao7",
                  !Boolean(pagesSections.get("secao7"))
                )
              }
              id="remember"
              type="checkbox"
        ...
        <div class="flex items-start mb-6">
          <div class="flex items-center h-5 ml-[20px]">
            <input
              checked={Boolean(pagesSections.get("secao8"))}
              onChange={() =>
                alterarPageSection(
                  "secao8",
                  !Boolean(pagesSections.get("secao8"))
                )
              }
              id="remember"
              type="checkbox"
                  ...
                  >
                    <div class="py-5 border-b border-gray-200 dark:border-gray-700">
                      ...
                      <button
                        type="button"
                        onClick={() => {
                          exibirModalCustomizacao("secao8_prop7");
                        }}
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                  ...
                  >
                    <div class="py-5 border-b border-gray-200 dark:border-gray-700">
                      ...
                      <button
                        type="button"
                        onClick={() => {
                          exibirModalCustomizacao("secao8_prop9");
                        }}
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="flex items-start mb-6">
          <div class="flex items-center h-5 ml-[20px]">
            <input
              checked={Boolean(pagesSections.get("secao9"))}
              onChange={() =>
                alterarPageSection(
                  "secao9",
                  !Boolean(pagesSections.get("secao9"))
                )
              }
              id="remember"
              type="checkbox"
        ...
        <div class="flex items-start mb-6 ml-[20px]">
          <div class="flex items-center h-5">
            <input
              checked={Boolean(pagesSections.get("secao10"))}
              onChange={() =>
                alterarPageSection(
                  "secao10",
                  !Boolean(pagesSections.get("secao10"))
                )
              }
              id="remember"
              type="checkbox"
            ...
            <div class="max-w-screen-xl px-4 mx-auto">
              <div class="text-center mb-8">
                <h2 class="text-4xl font-extrabold text-gray-900 dark:text-white">
                  {pagesProps.get("secao10_prop1") || "Agende um horário"}
                </h2>
                <button
                  type="button"
                  onClick={() => {
                    exibirModalCustomizacao("secao10_prop1");
                  }}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <p class="text-lg text-gray-500 dark:text-gray-400">
                  {pagesProps.get("secao10_prop2") ||
                    "Escolha um horário e preencha seus dados para que possamos entrar em contato."}
                  <button
                    type="button"
                    onClick={() => {
                      exibirModalCustomizacao("secao10_prop2");
                    }}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="flex items-start mb-6 ml-[20px]">
          <div class="flex items-center h-5">
            <input
              checked={Boolean(pagesSections.get("secao11"))}
              onChange={() =>
                alterarPageSection(
                  "secao11",
                  !Boolean(pagesSections.get("secao11"))
                )
              }
              id="remember"
              type="checkbox"
